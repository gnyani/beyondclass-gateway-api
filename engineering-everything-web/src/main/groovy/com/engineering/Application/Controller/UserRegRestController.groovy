...
//        //******************************VALIDATION DONE **********************\\
//        try {
//            user.setUsername(validEmail.getResult())
...
//            println(u.toString());
//            println("returned" + passwordEncoder.matches(person.getPassword(),u.getPassword()))
//            //println("encoded password" + passwordEncoder.encode(person.getPassword()))
//
//            if (u != null) {
//                if (passwordEncoder.matches(person.getPassword(),u.getPassword())) {
