...
class EngineeringEverythingRepositoryTest extends Specification{
    ...
    public void TestUserRepo1(){
        ...
        def User1 = new User("test123456@gmailcom","gnyani","nath","ou","vasv","cse","071","B","4","2","No",dob,"741600585",LocalDateTime.now());
    ...
    public void TestUserRepo2(){
        ...
        def User1 = new User("test123456@gmailcom","gnyani","nath","ou","vasv","cse","071","B","4","2","No",dob,"741600585",LocalDateTime.now());
        userRepository.insert(User1);
        def User2 = new User("test123456@gmailcom","gnyani","nath","ou","vasv","cse","071","B","4","2","No",dob,"741600585",LocalDateTime.now());
        try{
